...
\begin{decision}[title={This revision corrects a hardware-role error from the prior plan (2026-09-08)}]
The previous revision of this plan treated LAN8660/LAN8661 as a secondary, time-boxed investigation and proposed a single MCU+LAN8651 board that would become either an E2B or a Gateway by component population. Both positions are superseded. LAN8660 and LAN8661 are \textbf{mandatory} for the November Greenfield proof -- they are Alfred's actual Control and Lighting E2B endpoints, not a stretch goal. And because LAN8660/LAN8661 are MCU-less fixed-function devices while the Gateway role structurally requires a programmable MCU, \textbf{one identical PCB cannot become both an E2B and a Gateway.} The corrected architecture is one shared \emph{electrical platform philosophy} (Section~\ref{sec:platform-strategy}) realized as three sibling node classes -- E2B-Control (LAN8660), E2B-Lighting (LAN8661), and Gateway (MCU~+~LAN8651) -- sharing power, protection, connectors, mechanical language, and validation discipline, not silicon.
\end{decision}
